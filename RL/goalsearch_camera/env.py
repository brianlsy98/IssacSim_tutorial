...
class JackalEnv(gym.Env):
    ...
    def __init__(
        ...
        from omni.isaac.jackal import Jackal    ## .urdf -> .usd
    ...
    def step(self, action):
        ...
        if current_dist_to_goal < 50:
            ...
            self.goal.set_world_pose(np.array([math.sin(alpha) * r, math.cos(alpha) * r, 10]))
    ...
    def get_observations(self):
        ...
        # wait_for_sensor_data is recommended when capturing multiple sensors,
        # in this case we can set it to zero as we only need RGB
